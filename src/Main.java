...
public class Main {
	...
	public static void main(String[] a) {	
		...
		xMax.setValue(5); xMax.setColumns(4);
		...
		c.gridheight = 1; c.weightx = 0; c.weighty = 0.5; c.gridx = 1;
		...
		gridLineIntervalX.setValue(1); gridLineIntervalX.setColumns(6);
		gridLineIntervalY.setValue(1); gridLineIntervalY.setColumns(6);
